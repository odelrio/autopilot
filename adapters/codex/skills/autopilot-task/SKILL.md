---
name: autopilot-task
description: Codex adapter — execute one roadmap item end-to-end. Execute one roadmap item end-to-end — claim, optional spec gate, implement, verify, review ritual, open PR, merge, bookkeeping. Use when told to work the roadmap queue or a specific item id, driven by the project's roadmap.config.md. Invoked per-item by $autopilot-solo and $autopilot-fleet.
---
