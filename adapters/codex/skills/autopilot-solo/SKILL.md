---
name: autopilot-solo
description: Codex adapter — autonomous single-agent roadmap execution. Works items end-to-end via autopilot-task, one at a time, without blocking, until a stop condition.
---
