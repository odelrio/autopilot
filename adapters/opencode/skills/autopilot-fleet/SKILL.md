...
description: OpenCode adapter — orchestrate parallel autonomous roadmap execution. Claims items per lane, spawns subagents, and runs a strictly-serial merge queue.
---
...
**Note:** OpenCode subagent support may vary by host configuration. If subagents are available, spawn one per claimed
